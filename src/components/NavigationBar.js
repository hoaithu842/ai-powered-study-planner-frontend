    ...
    return (
        currentUser && (
            <Navbar bg="light" data-bs-theme="light" sticky='top' expand='md'>
                <Container>
                    <Navbar.Brand as={Link} to="/" className='navbar-brand'><img src={logo}/>AI-Powered Study
                        Planner</Navbar.Brand>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav" className="justify-content-end">
                        <Nav>
                            ...
                            <Nav.Link as={Link} to="/schedule"
                                      className={location.pathname === "/schedule" || location.pathname === "/" ? "nav-link active" : "nav-link"}>
                                Schedule
                            </Nav.Link>
                            ...
                            <Nav.Link as={Link} to="/profile"
                                      className={location.pathname === "/profile" ? "nav-link active me-2" : "nav-link me-2"}>
                                <Image
