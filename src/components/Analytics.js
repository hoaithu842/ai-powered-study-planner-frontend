                                    ...
                                    analytics?.taskProgress?.map((task) => (
                                        <Card key={task.taskId} className="mb-3">
                                            <Card.Body>
                                                ...
                                                <Card.Text><strong>Focus Time:</strong> {task.focusTime} mins<strong>Estimated Time:</strong> {task.estimatedTime} hours</Card.Text>
                                                <Card.Text><ProgressBar now={task.progress} label= {`${task.progress}%`}></ProgressBar></Card.Text>
                                            </Card.Body>
                                        </Card>
                                    ))
                                    )
